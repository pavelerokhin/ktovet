...
class SeleniumCommandsTests(unittest.TestCase):
    def test_find_elements(self):
        ...
        actions = Actions(actions=[Action(name="Get page", command=get_page, context=context),
                                   Action(name="Find all", command=find_all, result_to="elements", context=context)])
    ...
    def test_stage_failure(self):
        ...
        # Define a mock schema with required attributes
        actions = Actions(actions=[Action(name="load site", command=get_page, context=context)])
